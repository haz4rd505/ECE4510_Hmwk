...
errterm = normrnd(0,.005,1,32)
%Adding a single gross error
errterm(1) = 1;
errterm(32) = .5;
errterm(28) = -.5;

%The bottom Z includes the error term, the top one does not.
...
Z=[Pinj1;Pinj2;Pinj3;Pinj4;Pinj5;Qinj1;Qinj2;Qinj3;Qinj5;P12;-P21;P23;-P32;-P24;P42;P45;-P54;P15;-P51;Q12;Q21;Q24;Q42;Q45;Q54;Q15;Q51;v1;v2;v3;v4;v5;]+transpose(errterm)


littleh = [Pvec{1},Pvec{2},Pvec{3},Pvec{4},Pvec{5},Qvec{1},Qvec{2},Qvec{3},Qvec{5},...
           Pmat(1,2),Pmat(2,1),Pmat(2,3),Pmat(3,2),Pmat(2,4),Pmat(4,2),Pmat(4,5),Pmat(5,4),Pmat(1,5),Pmat(5,1),...
           Qmat(1,2),Qmat(2,1),Qmat(2,4),Qmat(4,2),Qmat(4,5),Qmat(5,4),Qmat(1,5),Qmat(5,1),Vone,Vtwo,Vthree,Vfour,Vfive]
...
bar(residuals)
set(gca,'XTick',[1:length(Z)],'XTickLabel',{'P1','P2','P3','P4','P5','Q1','Q2','Q3','Q5','P12','P21','P23','P32','P24','P42','P45','P54','P15','P51','Q12','Q21','Q24','Q42','Q45','Q54','Q15','Q51','V1','V2','V3','V4','V5'})
title('Residuals for Multiple Gross States')

%%Displaying the results
Zlabels = {'Pinj1','Pinj2','Pinj3','Pinj4','Pinj5','Qinj1','Qinj2','Qinj3','Qinj5','P12','-P21','P23','-P32','-P24','P42','P45','-P54','P15','-P51','Q12','Q21','Q24','Q42','Q45','Q54','Q15','Q51','v1','v2','v3','v4','v5'}
